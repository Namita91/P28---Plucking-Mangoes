...
var world,boy;
var launcherObj, launchForce = 100;
...
function setup() {
  ...
  mango2=new mango(1170,130,30);
	...
	treeObj=new tree(1030,290);
	groundObject=new ground(width/2,600,width,20);
  stoneObj=new stone(235,420,30); 
  
  launcherObj = new launcher({x:238,y:423},stoneObj.body);
...
function mouseDragged() {
  // stoneObj.body.position.x = mouseX;
  // stoneObj.body.position.y = mouseY;
